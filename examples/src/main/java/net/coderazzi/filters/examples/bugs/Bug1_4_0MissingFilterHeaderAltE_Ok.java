...
/**
 * Variation of Bug1_4_0MissingFilterHeaderAltC_Ok. The table and header are
 * setup after adding the table to the container, but in opposite order This
 * test run fine on version 1.4.0
 */
